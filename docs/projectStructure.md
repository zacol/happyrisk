...
- _Note:_ While `apps/web` contains dashboard components, this package can store shared design tokens or primitive UI elements if multiple web apps are added later.
